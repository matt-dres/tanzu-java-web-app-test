...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=matt-dres&repo=tanzu-java-web-app-test",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=matt-dres&repo=tanzu-java-web-app-test'
